...
class MenuComunidadeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_comunidade_menu)
        ...
        val botaoPerfil = findViewById<ImageButton>(R.id.perfil_comunidade)
        botaoPerfil.setOnClickListener {
            val intent = Intent(this, PerfilComunidadeActivity::class.java)
            startActivity(intent)
        }
